...
class Opciones2 : AppCompatActivity() {
    ...
    private val model by lazy { ViewModelProviders.of(this)[GameViewModel(this)::class.java] }
...
//      Categorias CheckBox logica
        ...
        fisicaCheckBox.isChecked = Configuration.conf.categories[3]
        na1CheckBox.isChecked = Configuration.conf.categories[4]
        na2CheckBox.isChecked = Configuration.conf.categories[5]
